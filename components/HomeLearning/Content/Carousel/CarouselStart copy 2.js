    ...
    <div className="container-fluid p-1 mb-5">
      ...
      >
        <div className="owl-carousel-item position-relative">
          ...
          <div
            className={`position-absolute top-1 start-0 w-100 h-100 d-flex align-items-center overlay ${styles.hello}`}
        ...
        <div className="owl-carousel-item position-relative">
          ...
          <div
            className={`position-absolute top-1 start-0 w-100 h-100 d-flex align-items-center ${styles.overlay}`}
            style={{ background: "rgba(24, 29, 56, .7)" }}
          >
            <div className="container">
              <div className="row justify-content-start">
